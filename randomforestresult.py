...
class Ui_Form4(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Random Forest"))
        self.label.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:24pt; font-weight:600; color:#2194ef;\">RANDOM FOREST</span></p></body></html>"))
