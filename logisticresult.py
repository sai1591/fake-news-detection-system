...
# Form implementation generated from reading ui file 'logisticresult.ui'
#
...
class Ui_Form1(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Logistic Regression"))
        self.label.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:24pt; font-weight:600; color:#2194ef;\">LOGISTIC REGRESSION</span></p></body></html>"))
