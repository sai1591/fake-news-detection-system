...
# -*- coding: utf-8 -*-
"""
Created on Sat Apr 16 22:09:39 2022
...
class Ui_Form5(object):
    ...
    def copy(self):
           ...
           cm=confusion_matrix(y_test,pred_paag)
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Passive Aggressive"))
        self.label.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:24pt; font-weight:600; color:#2194ef;\">PASSIVE AGGRESSIVE</span></p></body></html>"))
